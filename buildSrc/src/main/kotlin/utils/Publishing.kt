...
import gradle.kotlin.dsl.accessors._523dc74e2e9552463686721a7434f18b.remapSourcesJar
...
fun mavenPublish(template : TxniTemplateBuild) : PublishingExtension.() -> Unit = { template.apply {
    publications {
